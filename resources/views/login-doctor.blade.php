    ...
    <div class="max-w-md w-full">
      <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <div class="flex items-center mb-6">
          ...
          <h1 class="text-2xl font-bold text-gray-900">Connexion Médecin</h1>
        </div>
        ...
        <form method="POST" action="{{ route('login.doctor') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('password.request') }}" class="text-sm text-red-500 hover:text-red-600">Mot de passe oublié ?</a>
            </div>
        ...
        <div class="mt-8 text-center">
          <p class="text-gray-600">Pas encore de compte médecin ? 
            <a href="{{ route('register.doctor') }}" class="text-red-500 hover:text-red-600 font-semibold">S'inscrire</a>
          </p>
        </div>
      </div>
    </div>
