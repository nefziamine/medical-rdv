      ...
      <div class="bg-white rounded-lg shadow-md p-8">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="email" name="email" required class="w-full border border-gray-300 px-4 py-3 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent">
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    <input type="checkbox" id="remember" name="remember" class="h-4 w-4 text-red-500 focus:ring-red-500 border-gray-300 rounded">
                    <label for="remember" class="ml-2 text-sm text-gray-600">Se souvenir de moi</label>
                </div>
                <a href="/forgot-password" class="text-sm text-red-500 hover:text-red-600">Mot de passe oublié ?</a>
            </div>
        ...
        <div class="mt-8 text-center">
          <p class="text-gray-600">Pas encore de compte ? 
            <a href="/register" class="text-red-500 hover:text-red-600 font-semibold">S'inscrire</a>
          </p>
        </div>
      </div>
    </div>
