  ...
  <div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="text-center">
        ...
        <h2 class="text-3xl font-bold text-gray-900 mb-2">Choisissez votre type de compte</h2>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-2 border-transparent hover:border-red-500 transition-all duration-300 cursor-pointer" 
          ...
          <div class="flex items-center space-x-4">
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-600">Je veux prendre des rendez-vous médicaux</p>
            </div>
      ...
      <div class="text-center">
        <p class="text-gray-600">
          ...
          <a href="{{ route('login') }}" class="text-red-500 hover:text-red-600 font-semibold">
            Connectez-vous ici
          </a>
        </p>
      </div>
